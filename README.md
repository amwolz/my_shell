...
- **Builtin Commands** — Accepts several builtin commands. A list of these commands can be found in the help menu `my_shell> help`.
...
The test files **/bin/test/wait**, **/bin/test/wait_print**, **/bin/test/wait_fork_zombies**, and **/bin/test/wait_fork_orphans** are provided and demonstrate the behavior of the shell.
...
![demo](https://github.com/user-attachments/assets/d8b7ae36-02f6-449a-b2fb-12407af6446d)
